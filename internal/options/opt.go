...
type Opts struct {
	...
	URL       string   `short:"p" long:"provider-url" env:"PROVIDER_URL" description:"url where map-tile-provider serving"`
	...
	Points    string   `long:"points" env:"POINTS" default:"./points.json" description:"what points download"`
}
